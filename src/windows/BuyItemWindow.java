...
public class BuyItemWindow {
	...
	private void initialize() {
		...
		JLabel lblMoney = new JLabel(String.format("Money: %s", Integer.toString(game.getMoney())));
		lblMoney.setBounds(12, 12, 128, 15);
		frame.getContentPane().add(lblMoney);
	
		
		JLabel lblWeek = new JLabel(String.format("Week: %s", Integer.toString(game.getWeek())));
		...
		JButton btnItem1 = new JButton(market.itemsForSale.get(0).getName());
		...
		JButton btnItem2 = new JButton(market.itemsForSale.get(1).getName());
		...
		JButton btnItem3 = new JButton(market.itemsForSale.get(2).getName());
		...
		JButton btnItem4 = new JButton(market.itemsForSale.get(3).getName());
