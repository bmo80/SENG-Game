	...
	private void initialize() {
		...
		btnPurchase.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println(market.getGameStats().getMoney());
//						addAthlete(market.getPlayersForSale().get(athleteSelected-1));
				System.out.println(market.getGameStats().getTeams().getTeamList());
				...
				market.getPlayersForSale().get(athleteSelected-1).setName("Purchased");
			}
		});
